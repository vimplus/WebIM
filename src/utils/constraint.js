...
const constraintContactBasic = data => constraintObject(data, {
    id: true,
    displayName: true,
    avatar: true,
    type: {
...
const constraintMessageBasic = data => constraintObject(data, {
    content: true,
    sendTime: true,
    type: {
        required: true,
...
constraintMessage({
    ...
    fromContactId: '123',
    fromUser: {
        id: '123', displayName: '123', avatar: '123', type: 'single'
    }
});

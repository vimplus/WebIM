    ...
    methods: {
        ...
        _renderSidebarMessage() {
            return this._renderSidebar(
                [
                    useScopedSlot(this.$slots['sidebar-message-top'], null, this),
                    this.lastMessages.map(contact => this._renderContact(
                        ...
                        this.$slots['sidebar-message']
                    ))
                ],
                DEFAULT_MENU_LASTMESSAGES,
                useScopedSlot(
                    this.$slots['sidebar-message-fixedtop'],
                    null,
                    this
                )
            );
        ...
        _renderSidebarContact() {
            ...
            return this._renderSidebar(
                [
                    useScopedSlot(this.$slots['sidebar-contact-top'], null, this),
                ...
                DEFAULT_MENU_CONTACTS,
                useScopedSlot(
                    this.$slots['sidebar-contact-fixedtop'],
                    null,
                    this
                )
            );
        ...
        _renderDrawer() {
            return this._menuIsMessages() && this.currentContactId ? (
              <div class="witalk-drawer" ref="drawer">
                ...
                {useScopedSlot(this.$slots.drawer, '', this.currentContact)}
              </div>) : ('');
        },
                ...
                <div class={cls} v-show={this._menuIsMessages() && defIsShow && curact.id}>
                    ...
                    <div class="witalk-vessel">
                        ...
                        <div class="witalk-vessel-right">
                            {useScopedSlot(this.$slots['message-side'], null, curact)}
                        </div>
                    </div>
                </div>
            );

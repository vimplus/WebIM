...
const generateRandId = () => Math.random()
    .toString(36)
    .substr(-8);
const generateRandWord = () => Math.random()
    .toString(36)
    .substr(2);
...
export default {
    ...
    data() {
        return {
            ...
            contextmenu: [
                ...
                {
                    visible: instance => instance.message.type === 'text',
                    text: '复制文字'
                },
                {
    ...
    mounted() {
        ...
        const contactData2 = {
            ...
            renderContainer: () => <h1 style="text-indent:20px">自定义页面</h1>,
        ...
        IMUI.setLastContentRender('event', () => '[自定义通知内容]');
        ...
        // eslint-disable-next-line no-unused-vars
        IMUI.setLastContentRender('voice', message => <span>[语音]</span>);
